...
3. **No Inter-Annotator Collusion**: Annotators evaluated the blind sample independently adhering strictly to [`evaluations/golden_set/labeling_guide.md`](evaluations/golden_set/labeling_guide.md).
